...
export default function Home() {
  ...
  const howToSteps = [
    { icon: <CalendarSearch className="h-8 w-8" />, title: "Lugar, hora y fecha", description: "Seleccione lugar, hora y fecha." },
    { icon: <Car className="h-8 w-8" />, title: "Autos disponibles", description: "Elija un auto de los resultados." },
    { icon: <User className="h-8 w-8" />, title: "Datos personales", description: "Complete sus datos. Confirmamos en 24h." },
    { icon: <CreditCard className="h-8 w-8" />, title: "Pagar reserva", description: "Recibirá un link de pago." },
    { icon: <MailCheck className="h-8 w-8" />, title: "Recibe tu Voucher", description: "Enviamos su Voucher y factura." }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Header />
      <main>
        <section className="hero-moderno text-white">
          <div className="container mx-auto px-4 py-24 md:py-32 text-center">
            <div className="inline-block bg-white/15 px-5 py-2 rounded-lg mb-6 text-sm font-medium backdrop-blur-sm">Excelencia en Movilidad</div>
        ...
        <section id="como-funciona" className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="font-headline text-3xl md:text-4xl font-bold text-center mb-2 text-primary">¿Cómo reservar?</h2>
            <p className="text-accent text-center text-sm font-medium uppercase tracking-widest mb-12">Solo 5 pasos</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
               {howToSteps.map((step, index) => (
                   <div key={index} className="relative text-center group">
                       <div className="mx-auto bg-gradient-to-br from-primary to-[hsl(230,55%,48%)] text-white rounded-xl h-20 w-20 flex items-center justify-center mb-4 shadow-md group-hover:shadow-xl group-hover:scale-105 transition-all duration-300">
          ...
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-end mb-10">
              <div>
                ...
                <p className="text-muted-foreground mt-2">Selección exclusiva</p>
              </div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="font-headline text-3xl md:text-4xl font-bold text-center mb-2 text-primary">¿Por qué elegirnos?</h2>
            <p className="text-accent text-sm font-medium uppercase tracking-widest text-center mb-12">Nuestros pilares</p>
              ...
              <Card className="shadow-md border border-primary/10 rounded-xl">
                ...
                <CardContent>
                  <ul className="space-y-3 text-muted-foreground">
                    <li className="flex gap-2"><span className="text-accent mt-1">—</span>Edad mínima 21 años, máxima 80 años.</li>
                    <li className="flex gap-2"><span className="text-accent mt-1">—</span>Licencia de conducción vigente (mín. 2 años).</li>
                    <li className="flex gap-2"><span className="text-accent mt-1">—</span>Pasaporte vigente y Voucher impreso.</li>
                    <li className="flex gap-2"><span className="text-accent mt-1">—</span>Gasolina, impuesto aeropuerto y seguro pueden estar incluidos.</li>
                    <li className="flex gap-2"><span className="text-accent mt-1">—</span>Devolución en punto diferente: cargo extra.</li>
                    <li className="flex gap-2"><span className="text-accent mt-1">—</span>Seguro obligatorio. Pagos solo con tarjeta.</li>
                  </ul>
                </CardContent>
              </Card>
              <Card className="shadow-md border border-primary/10 rounded-xl">
        ...
        <section className="hero-moderno py-16">
